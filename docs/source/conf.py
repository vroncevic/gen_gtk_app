...
Copyright
    ...
    gen_gtk_app is distributed in the hope that it will be useful, but
...
project: str = 'gen_gtk_app'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '2.0'
release: str = 'https://github.com/vroncevic/gen_gtk_app/releases'
...
htmlhelp_basename: str = 'gen_gtk_appdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_gtk_app.tex', 'gen_gtk_app Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_gtk_app', 'gen_gtk_app Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_gtk_app', 'gen_gtk_app Documentation', author,
